...
def test_case3():
    ...
    sleep(10)
    browser_me.find_element(By.NAME, "username").send_keys("testwal20@gmail.com")
    browser_me.find_element(By.NAME, "password").send_keys("Testyh23")
    browser_me.find_element(By.ID, "ShowCharacter").click()
    browser_me.find_element(By.ID, "submit_btn").click()
    sleep(20)
    browser_me.quit()
